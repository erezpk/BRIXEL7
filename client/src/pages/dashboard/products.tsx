...
export default function ProductsPage() {
  ...
  const handleEdit = (product: Product) => {
    ...
    form.reset({
      ...
      price: product.price / 100, // Convert from agorot to shekels
      unit: product.unit,
  ...
  const handleDelete = (id: string) => {
    if (confirm('האם אתה בטוח שברצונך למחוק את המוצר/שירות?')) {
      ...
      <div className="p-6" dir="rtl">
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">טוען מוצרים ושירותים...</p>
          </div>
        </div>
      </div>
    );
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                  <TabsList className="grid w-full grid-cols-2">
                    <TabsTrigger value="basic">פרטי בסיס ומתחור</TabsTrigger>
                    <TabsTrigger value="tasks">תבנית משימות</TabsTrigger>
                  </TabsList>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-muted-foreground">
                    /{product.unit === 'project' ? 'פרויקט' : 
                      ...
                      product.unit === 'day' ? 'יום' :
                      product.unit === 'week' ? 'שבוע' :
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-muted-foreground text-center mb-4">
                  התחל על ידי יצירת המוצרים והשירותים שלך
                </p>
