    ...
    const handleGoogleRedirect = async () => {
      try {
        ...
        if (result && result.success) {
          ...
          toast({
            title: "הצלחה",
            description: "התחברת בהצלחה עם Google",
          });
        ...
        console.log('No Google redirect result or error:', error);
      }
    };
          ...
          <div className="mt-4">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-2 text-muted-foreground">או התחבר עם</span>
              </div>
            </div>
